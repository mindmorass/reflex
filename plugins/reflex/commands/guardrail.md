...
echo "| drop_table | database_destructive | DROP TABLE |"
...
echo "| git_branch_force_delete | git_destructive | git branch -D (force-delete) |"
echo "| git_rebase_remote | git_destructive | git rebase on remote branch |"
echo "| az_account_set | cloud_destructive | az account set (mutates CLI state) |"
echo "| terraform_destroy | cloud_destructive | terraform destroy |"
echo "| aws_terminate | cloud_destructive | AWS resource termination |"
echo "| gcloud_delete | cloud_destructive | GCP resource deletion |"
echo "| az_delete | cloud_destructive | Azure resource deletion |"
echo "| kubectl_delete_namespace | cloud_destructive | K8s namespace deletion |"
echo "| kubectl_delete_all | cloud_destructive | K8s delete --all |"
echo "| docker_system_prune_all | container_destructive | docker system prune -a |"
echo "| docker_rm_force | container_destructive | docker rm/rmi --force |"
echo "| jira_delete_issue | api_destructive | Jira issue deletion |"
echo "| confluence_delete_page | api_destructive | Confluence page deletion |"
echo ""
...
echo "| kubectl_apply_force | cloud_destructive | kubectl apply --force |"
...
echo "| docker_image_prune | container_destructive | Docker image pruning |"
echo "| jira_remove_issue_link | api_destructive | Jira link removal |"
```
